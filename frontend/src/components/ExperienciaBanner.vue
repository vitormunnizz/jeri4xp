<template>
  <section id="experiencia" class="min-h-screen w-full flex flex-col items-center justify-center bg-white p-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl">
      ...
      <div
        class="group relative h-70 rounded-3xl flex flex-col justify-end items-start p-10 overflow-hidden bg-black shadow-xl">
        <img src="../assets/passeio.webp"
          class="absolute inset-0 w-full h-full object-cover opacity-70 transition-all duration-700 group-hover:scale-110 group-hover:opacity-50"
          alt="Passeios">

        <div class="relative z-10">
          <h2 class="text-white text-4xl font-black mb-4 uppercase italic tracking-tighter">Passeios</h2>
          <router-link to="/passeios">
            <button
