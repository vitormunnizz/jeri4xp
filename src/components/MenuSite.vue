...
const footerTitulo = [
  { name: 'Titulo', describe: 'Sua aventura em Jericoacoara começa aqui' },
]

const footerTexto = [
  { name: 'Text', describe: 'Turismo com qualidade, aventuras personalizadas e memórias inesquecíveis em Jericoacoara.' },
]
