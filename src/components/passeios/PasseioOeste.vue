        ...
        <div class="max-w-5xl mx-auto relative z-10 w-full">
            <div class="bg-white rounded-4xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse border border-white/20">
                ...
                <div class="md:w-5/12 relative min-h-64 md:min-h-full">
                    <img src="../../assets/jeri1.webp" alt="Passeio Lado Oeste Jericoacoara" class="absolute inset-0 w-full h-full object-cover"/>
                </div>
                ...
                <div class="md:w-7/12 p-8 md:p-10 lg:p-12 flex flex-col justify-center">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-8">
                        <div v-for="item in ['Mangue Seco', 'Rio Guriú', 'Dunas de Tatajuba', 'Lagoa da Torta']" :key="item" class="flex items-center gap-2 group">
                            ...
                            <span class="font-bold text-slate-700 text-xs md:text-sm tracking-tight">
                                {{ item }}
                            </span>
                        </div>
                    </div>
